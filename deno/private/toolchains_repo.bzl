...
"
The "complex computation" in our case is simply downloading the deno binary from github.
...
def _resolved_toolchain_impl(ctx):
    toolchain_info = ctx.toolchains["@dev_aspect_rules_deno//deno:toolchain_type"]
    return [
        toolchain_info,
        toolchain_info.default,
        toolchain_info.denoinfo,
...
resolved_toolchain = rule(
    ...
    toolchains = ["@dev_aspect_rules_deno//deno:toolchain_type"],
...
# By default all these toolchains are registered by the deno_register_toolchains macro
...
toolchain(
    ...
    toolchain_type = "@dev_aspect_rules_deno//deno:toolchain_type",
)
""".format(
            platform = platform,
